...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { descripcion: @field.descripcion, foto: @field.foto, local_id: @field.local_id, nombre: @field.nombre, tarifa: @field.tarifa } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { descripcion: @field.descripcion, foto: @field.foto, local_id: @field.local_id, nombre: @field.nombre, tarifa: @field.tarifa } }
