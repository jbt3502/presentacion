...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post promotions_url, params: { promotion: { descripcion: @promotion.descripcion, local_id: @promotion.local_id } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { descripcion: @promotion.descripcion, local_id: @promotion.local_id } }
